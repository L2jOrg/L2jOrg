...
public class WhoAmI extends ScriptVoiceCommandHandler
{
	...
	public boolean useVoicedCommand(String command, Player player, String args)
	{
		...
		replaceFirst(sb,"%bleedPower%", bleedPower == Double.POSITIVE_INFINITY ? "Invul." : df.format(bleedPower));
		replaceFirst(sb,"%bleedResist%", bleedResist == Double.POSITIVE_INFINITY ? ( "Invul.") : df.format(bleedResist));
		replaceFirst(sb,"%poisonPower%", poisonPower == Double.POSITIVE_INFINITY ? ( "Invul.") : df.format(poisonPower));
		replaceFirst(sb,"%poisonResist%", poisonResist == Double.POSITIVE_INFINITY ? ( "Invul.") : df.format(poisonResist));
		replaceFirst(sb,"%stunPower%", stunPower == Double.POSITIVE_INFINITY ? ("Invul.") : df.format(stunPower));
		replaceFirst(sb,"%stunResist%", stunResist == Double.POSITIVE_INFINITY ? ( "Invul.") : df.format(stunResist));
		replaceFirst(sb,"%rootPower%", rootPower == Double.POSITIVE_INFINITY ? ("Invul.") : df.format(rootPower));
		replaceFirst(sb,"%rootResist%", rootResist == Double.POSITIVE_INFINITY ? ( "Invul.") : df.format(rootResist));
		replaceFirst(sb,"%sleepPower%", sleepPower == Double.POSITIVE_INFINITY ? ("Invul.") : df.format(sleepPower));
		replaceFirst(sb,"%sleepResist%", sleepResist == Double.POSITIVE_INFINITY ? ( "Invul.") : df.format(sleepResist));
		replaceFirst(sb,"%paralyzePower%", paralyzePower == Double.POSITIVE_INFINITY ? ( "Invul.") : df.format(paralyzePower));
		replaceFirst(sb,"%paralyzeResist%", paralyzeResist == Double.POSITIVE_INFINITY ? ( "Invul.") : df.format(paralyzeResist));
		replaceFirst(sb,"%mentalPower%", mentalPower == Double.POSITIVE_INFINITY ? ( "Invul.") : df.format(mentalPower));
		replaceFirst(sb,"%mentalResist%", mentalResist == Double.POSITIVE_INFINITY ? ("Invul.") : df.format(mentalResist));
		...
		replaceFirst(sb,"%swordResist%", swordResist == Double.POSITIVE_INFINITY ? ( "Invul.") : df.format(swordResist));
		replaceFirst(sb,"%dualResist%", dualResist == Double.POSITIVE_INFINITY ? ( "Invul.") : df.format(dualResist));
		replaceFirst(sb,"%bluntResist%", bluntResist == Double.POSITIVE_INFINITY ? ( "Invul.") : df.format(bluntResist));
		replaceFirst(sb,"%daggerResist%", daggerResist == Double.POSITIVE_INFINITY ? ( "Invul.") : df.format(daggerResist));
		replaceFirst(sb,"%bowResist%", bowResist == Double.POSITIVE_INFINITY ? ( "Invul.") : df.format(bowResist));
		replaceFirst(sb,"%crossbowResist%", crossbowResist == Double.POSITIVE_INFINITY ? ( "Invul.") : df.format(crossbowResist));
		replaceFirst(sb,"%twoHandCrossbowResist%", twoHandCrossbowResist == Double.POSITIVE_INFINITY ? ("Invul.") : df.format(twoHandCrossbowResist));
		replaceFirst(sb,"%fistResist%", fistResist == Double.POSITIVE_INFINITY ? ( "Invul.") : df.format(fistResist));
		replaceFirst(sb,"%poleResist%", poleResist == Double.POSITIVE_INFINITY ? ("Invul.") : df.format(poleResist));
