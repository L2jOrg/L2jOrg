...
public final class CommunityMail extends ScriptsCommunityHandler
{
	...
	protected void doBypassCommand(Player player, String bypass)
	{
		...
		if("maillist".equals(cmd))
		{
			...
			String html = HtmCache.getInstance().getHtml("scripts/org.l2j.scripts.handler/bbs/bbs_mail_list.htm", player);
			...
			if(mailList != null)
			{
				...
				String tpl = HtmCache.getInstance().getHtml("scripts/org.l2j.scripts.handler/bbs/bbs_mailtpl.htm", player);
		...
		else if("mailread".equals(cmd))
		{
			...
			try
			{
				...
				if(rset.next())
				{
					String html = HtmCache.getInstance().getHtml("scripts/org.l2j.scripts.handler/bbs/bbs_mail_read.htm", player);
