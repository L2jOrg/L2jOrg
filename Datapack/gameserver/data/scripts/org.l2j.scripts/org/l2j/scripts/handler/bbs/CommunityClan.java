...
import org.l2j.gameserver.network.l2.s2c.ExMailArrivedPacket;
...
public final class CommunityClan extends ScriptsCommunityHandler
{
	...
	protected void doBypassCommand(Player player, String bypass)
	{
		...
		else if("bbsclanlist".equals(cmd))
		{
			...
			HtmTemplates tpls = HtmCache.getInstance().getTemplates("scripts/org.l2j.scripts.handler/bbs/bbs_clanlist.htm", player);
			...
			String tpl = HtmCache.getInstance().getHtml("scripts/org.l2j.scripts.handler/bbs/bbs_clantpl.htm", player);
		...
		else if("bbsclanhome".equals(cmd))
		{
			...
			HtmTemplates tpls = HtmCache.getInstance().getTemplates("scripts/org.l2j.scripts.handler/bbs/bbs_clan.htm", player);
			String html = tpls.get(0);
		...
		else if("bbsclanadmin".equals(cmd))
		{
			...
			String html = HtmCache.getInstance().getHtml("scripts/org.l2j.scripts.handler/bbs/bbs_clanadmin.htm", player);
		...
		else if("mailwritepledgeform".equals(cmd))
		{
			...
			String html = HtmCache.getInstance().getHtml("scripts/org.l2j.scripts.handler/bbs/bbs_pledge_mail_write.htm", player);
		...
		else if("announcepledgewriteform".equals(cmd))
		{
			...
			HtmTemplates tpls = HtmCache.getInstance().getTemplates("scripts/org.l2j.scripts.handler/bbs/bbs_clanannounce.htm", player);
			String html = tpls.get(0);
	...
	private class Listener implements OnPlayerEnterListener
	{
		...
		public void onPlayerEnter(Player player)
		{
			...
			{
				String html = HtmCache.getInstance().getHtml("scripts/org.l2j.scripts.handler/bbs/clan_popup.htm", player);
				html = html.replace("%pledge_name%", clan.getName());
