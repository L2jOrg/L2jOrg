...
public class Bash implements IAdminCommandHandler, OnInitScriptListener
{
	...
	private static String wrongPage = "scripts/org.l2j.scripts.services/Bash-wrongPage.htm";
	private static String notPage = "scripts/org.l2j.scripts.services/Bash-notPage.htm";
	private static String readPage = "scripts/org.l2j.scripts.services/Bash-readPage.htm";

	private static String xmlData = getSettings(ServerSettings.class).dataPackRootPath().resolve("/data/bash.xml").toString();
	...
	@Bypass("org.l2j.scripts.services.Bash:showQuote")
