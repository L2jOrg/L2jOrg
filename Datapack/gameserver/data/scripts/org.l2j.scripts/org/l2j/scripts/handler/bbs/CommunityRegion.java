...
public final class CommunityRegion extends ScriptsCommunityHandler
{
	...
	protected void doBypassCommand(Player player, String bypass)
	{
		...
		{
			String tpl = HtmCache.getInstance().getHtml("scripts/org.l2j.scripts.handler/bbs/bbs_regiontpl.htm", player);
			...
			HtmTemplates tpls = HtmCache.getInstance().getTemplates("scripts/org.l2j.scripts.handler/bbs/bbs_region_list.htm", player);
		...
		else if("bbsreglist".equals(cmd))
		{
			...
			String html = HtmCache.getInstance().getHtml("scripts/org.l2j.scripts.handler/bbs/bbs_region_sellers.htm", player);
			...
			String tpl = HtmCache.getInstance().getHtml("scripts/org.l2j.scripts.handler/bbs/bbs_region_stpl.htm", player);
		...
		else if("bbsregview".equals(cmd))
		{
			...
			String title = "-";
			String tpl = HtmCache.getInstance().getHtml("scripts/org.l2j.scripts.handler/bbs/bbs_region_storetpl.htm", player);
			...
			String html = HtmCache.getInstance().getHtml("scripts/org.l2j.scripts.handler/bbs/bbs_region_view.htm", player);
