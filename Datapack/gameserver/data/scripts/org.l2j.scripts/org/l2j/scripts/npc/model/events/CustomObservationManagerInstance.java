...
import org.l2j.gameserver.network.l2.c2s.RequestBypassToServer;
import org.l2j.gameserver.network.l2.c2s.RequestOlympiadMatchList;
import org.l2j.gameserver.network.l2.components.CustomMessage;
import org.l2j.gameserver.network.l2.components.HtmlMessage;
import org.l2j.gameserver.network.l2.components.SystemMsg;
import org.l2j.gameserver.network.l2.s2c.ExReceiveOlympiadPacket;
...
public class CustomObservationManagerInstance extends NpcInstance
{
	...
	public void showChatWindow(Player player, int val, boolean firstTalk, Object... replace)
	{
		String fileName;
		if(val > 0)
			fileName = getTemplate().getHtmRoot() + "org.l2j.scripts.manager-" + val + ".htm";
		else
			fileName = getTemplate().getHtmRoot() + "org.l2j.scripts.manager.htm";
