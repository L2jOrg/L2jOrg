...
{
	@Bypass("org.l2j.scripts.services.ObtainTalisman:Obtain")
	public void Obtain(Player player, NpcInstance npc, String[] param)
	{
		...
		{
			Functions.show("scripts/org.l2j.scripts.services/ObtainTalisman-no.htm", player, npc);
			return;
		}
		...
		Functions.show("scripts/org.l2j.scripts.services/ObtainTalisman.htm", player, npc);
	}
}