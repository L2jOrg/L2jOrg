...
public class AdminEvent extends ScriptAdminCommand
{
		...
		switch(c)
		{
			case admin_events:
				if(wordList.length == 1)
					...
					activeChar.sendPacket(new HtmlMessage(5).setFile("admin/org.l2j.scripts.events/" + wordList[1].trim()));
				break;
	...
	{
		final HtmTemplates tpls = HtmCache.getInstance().getTemplates("admin/org.l2j.scripts.events/org.l2j.scripts.events.htm", activeChar);
