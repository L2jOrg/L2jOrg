	...
	protected void doBypassCommand(Player player, String bypass)
	{
		...
		if("cbbsservices".equals(cmd))
		{
			...
			else if("cabinet".equals(cmd2))
			{
				...
				{
					html = HtmCache.getInstance().getHtml("scripts/org.l2j.scripts.handler/bbs/pages/cabinet.htm", player);
			...
			{
				HtmTemplates tpls = HtmCache.getInstance().getTemplates("scripts/org.l2j.scripts.handler/bbs/pages/pa.htm", player);
				html = tpls.get(0);
			...
			else if("changename".equals(cmd2))
			{
				...
				if("player".equals(cmd3))
				{
					...
					HtmTemplates tpls = HtmCache.getInstance().getTemplates("scripts/org.l2j.scripts.handler/bbs/pages/change_player_name.htm", player);
					html = tpls.get(0);
				...
				else if("pet".equals(cmd3))
				{
					...
					HtmTemplates tpls = HtmCache.getInstance().getTemplates("scripts/org.l2j.scripts.handler/bbs/pages/change_pet_name.htm", player);
					html = tpls.get(0);
				...
				else if("clan".equals(cmd3))
				{
					...
					HtmTemplates tpls = HtmCache.getInstance().getTemplates("scripts/org.l2j.scripts.handler/bbs/pages/change_clan_name.htm", player);
					html = tpls.get(0);
			...
			else if("color".equals(cmd2))
			{
				...
				if("name".equals(cmd3))
				{
					...
					HtmTemplates tpls = HtmCache.getInstance().getTemplates("scripts/org.l2j.scripts.handler/bbs/pages/color_name_change.htm", player);
					html = tpls.get(0);
				...
				else if("title".equals(cmd3))
				{
					...
					HtmTemplates tpls = HtmCache.getInstance().getTemplates("scripts/org.l2j.scripts.handler/bbs/pages/color_title_change.htm", player);
					html = tpls.get(0);
			...
			else if("sex".equals(cmd2))
			{
				...
				HtmTemplates tpls = HtmCache.getInstance().getTemplates("scripts/org.l2j.scripts.handler/bbs/pages/change_sex.htm", player);
				html = tpls.get(0);
			...
			else if("expand".equals(cmd2))
			{
				...
				if("inventory".equals(cmd3))
				{
					...
					HtmTemplates tpls = HtmCache.getInstance().getTemplates("scripts/org.l2j.scripts.handler/bbs/pages/expand_inventory.htm", player);
					html = tpls.get(0);
				...
				else if("warehouse".equals(cmd3))
				{
					...
					HtmTemplates tpls = HtmCache.getInstance().getTemplates("scripts/org.l2j.scripts.handler/bbs/pages/expand_warehouse.htm", player);
					html = tpls.get(0);
				...
				else if("clanwarehouse".equals(cmd3))
				{
					...
					HtmTemplates tpls = HtmCache.getInstance().getTemplates("scripts/org.l2j.scripts.handler/bbs/pages/expand_clanwarehouse.htm", player);
					html = tpls.get(0);
			...
			else if("clanrep".equals(cmd2))
			{
				...
				HtmTemplates tpls = HtmCache.getInstance().getTemplates("scripts/org.l2j.scripts.handler/bbs/pages/clanrep.htm", player);
				html = tpls.get(0);
			...
			else if("karma".equals(cmd2))
			{
				...
				HtmTemplates tpls = HtmCache.getInstance().getTemplates("scripts/org.l2j.scripts.handler/bbs/pages/karma_pk.htm", player);
				html = tpls.get(0);
