...
public class CriticalRatePositionBonus extends AbstractEffect {
	...
	{
		effected.getStats().mergePositionTypeValue(Stat.CRITICAL_RATE, position, (amount / 100) + 1, MathUtil::mul);
	}
	
	@Override
	public void onExit(Creature effector, Creature effected, Skill skill)
	{
		effected.getStats().mergePositionTypeValue(Stat.CRITICAL_RATE, position, (amount / 100) + 1, MathUtil::div);
	}
}
