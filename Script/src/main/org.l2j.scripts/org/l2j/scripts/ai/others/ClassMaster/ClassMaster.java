...
public final class ClassMaster extends AbstractNpcAI {
    ...
    public String onAdvEvent(String event, Npc npc, Player player) {
        ...
        return switch (event) {
            case "buyitems" ->
                    npc != null && npc.getId() == 31756 ? "test_server_helper001a.html" : "test_server_helper001b.html";
    ...
    private record ClassChangeData(String name, CategoryType category, List<ItemHolder> requiredItems,
                                   List<ItemHolder> rewardedItems) {
