	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		switch (st.nextToken())
		{
			case "limit":
			{
				...
				{
					html.setHtml(getHtml(player, "mercmanager-aden-limit.html"));
				}
				else if (castle.getName().equalsIgnoreCase("Rune"))
				{
					html.setHtml(getHtml(player, "mercmanager-rune-limit.html"));
				}
				else
				{
					html.setHtml(getHtml(player, "mercmanager-limit.html"));
				}
