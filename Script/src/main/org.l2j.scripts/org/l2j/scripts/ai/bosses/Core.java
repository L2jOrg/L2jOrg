...
public final class Core extends AbstractNpcAI {
    ...
    static {
        MINNION_SPAWNS.put(DEATH_KNIGHT, List.of(
                new Location(17191, 109298, -6488),
                new Location(17564, 109548, -6488),
                new Location(17855, 109552, -6488),
                new Location(18280, 109202, -6488),
                new Location(18784, 109253, -6488),
                new Location(18059, 108314, -6488),
                new Location(17300, 108444, -6488),
                new Location(17148, 110071, -6648),
                new Location(18318, 110077, -6648),
                new Location(17726, 110391, -6648)
        ));

        MINNION_SPAWNS.put(DOOM_WRAITH, List.of(
                new Location(17113, 110970, -6648),
                new Location(17496, 110880, -6648),
                new Location(18061, 110990, -6648),
                new Location(18384, 110698, -6648),
                new Location(17993, 111458, -6584)
        ));

        MINNION_SPAWNS.put(SUSCEPTOR, List.of(
                new Location(17297, 111470, -6584),
                new Location(17893, 110198, -6648),
                new Location(17706, 109423, -6488),
                new Location(17849, 109388, -6480)
        ));
    }
    ...
    public void spawnBoss(GrandBoss npc) {
        ...
        Attackable mob;
        for (var spawns : MINNION_SPAWNS.entrySet()) {
            var locations = spawns.getValue();
            for (var location : locations) {
                mob = (Attackable) addSpawn(spawns.getKey(), location.getX(), location.getY(),location.getZ(), Rnd.get(61794), false, 0);
    ...
    public String onAdvEvent(String event, Npc npc, Player player) {
        if (event.equalsIgnoreCase("core_unlock")) {
            ...
            minions.forEach(Attackable::decayMe);
            minions.clear();
        }
