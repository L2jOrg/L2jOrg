...
public final class ClanHallAuctioneer extends AbstractNpcAI
{
    ...
    public String onAdvEvent(String event, Npc npc, Player player)
    {
        ...
        switch (event)
        {
            ...
            case "map":
            {
                htmltext = getHtml(player, "ClanHallAuctioneer-map.html");
            ...
            case "cancelBid":
            {
                ...
                htmltext = getHtml(player, "ClanHallAuctioneer-cancelBid.html");
            ...
            case "rebid":
            {
                if (player.hasClanPrivilege(ClanPrivilege.CH_AUCTION))
                {
                    ...
                    if (clanHallAuction != null)
                    {
                        ...
                        htmltext = getHtml(player, "ClanHallAuctioneer-bid2.html");
            ...
            case "my_auction":
            {
                ...
                final DateTimeFormatterBuilder builder = new DateTimeFormatterBuilder();
                htmltext = getHtml(player, "ClanHallAuctioneer-bidInfo.html");
    ...
    private void processClanHallBypass(Player player, Npc npc, BypassParser parser)
    {
        ...
        if (clanHallId > 0)
        {
            ...
            if (clanHall != null)
            {
                ...
                html.setHtml(getHtml(player, "ClanHallAuctioneer-info.html"));
        ...
        else
        {
            ...
            {
                final NpcHtmlMessage html = new NpcHtmlMessage(npc.getObjectId(), getHtml(player, "ClanHallAuctioneer-list.html"));
                //@formatter:off
    ...
    private void processBidBypass(Player player, Npc npc, BypassParser parser)
    {
        ...
        if (clanHallId > 0)
        {
            ...
            {
                final NpcHtmlMessage html = new NpcHtmlMessage(npc.getObjectId());
                html.setHtml(getHtml(player, "ClanHallAuctioneer-bid1.html"));
