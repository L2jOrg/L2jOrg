...
import static org.l2j.gameserver.mobius.gameserver.data.xml.impl.MultisellData.PAGE_SIZE;
...
public final class MultiSellList extends AbstractItemPacket {
    ...
    public void writeImpl(L2GameClient client, ByteBuffer packet) {
        ...
        packet.putInt(1 + (_index / PAGE_SIZE)); // page started from 1
        packet.putInt(_finished ? 0x01 : 0x00); // finished
        packet.putInt(PAGE_SIZE); // size of pages
