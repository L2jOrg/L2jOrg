...
public class EffectKnockBack extends EffectFlyAbstract
{
	...
	public EffectKnockBack(Abnormal abnormal, Env env, EffectTemplate template)
	{
	...
	public void onStart()
	{
        ...
        if(getEffected().getFlags().getKnockBacked().start(this))
        {
	...
	public void onExit()
	{
        if(getEffected().getFlags().getKnockBacked().stop(this))
		{
