...
import org.l2j.gameserver.network.l2.s2c.ExPrivateStoreBuyingResult;
...
public class RequestPrivateStoreBuySellList extends L2GameClientPacket
{
	...
	{
		_buyerId = buffer.getInt();
		_count = buffer.getInt();

		if(_count * 28 > buffer.remaining() || _count > Short.MAX_VALUE || _count < 1)
		{
			_count = 0;
			return;
		}
