...
public final class AllyLeave extends ClientPacket {
    ...
    public void runImpl() {
        ...
        clan.setAllyPenaltyExpiryTime(currentTime + getSettings(ClanSettings.class).daysToJoinAllyAfterLeft * 86400000L, Clan.PENALTY_TYPE_CLAN_LEAVED); // 24*60*60*1000 = 86400000
        clan.updateClanInDB();
