...
public class RequestPledgeReorganizeMember extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			activeChar.sendMessage(new CustomMessage("org.l2j.gameserver.network.l2.c2s.RequestPledgeReorganizeMember.ChangeAffiliations"));
			activeChar.sendActionFailed();
			return;
		}
		...
		if(subject == null)
		{
			activeChar.sendMessage(new CustomMessage("org.l2j.gameserver.network.l2.c2s.RequestPledgeReorganizeMember.NotInYourClan"));
			activeChar.sendActionFailed();
			return;
		}
		...
		{
			activeChar.sendMessage(new CustomMessage("org.l2j.gameserver.network.l2.c2s.RequestPledgeReorganizeMember.AlreadyInThatCombatUnit"));
			activeChar.sendActionFailed();
			return;
		}
		...
		{
			activeChar.sendMessage(new CustomMessage("org.l2j.gameserver.network.l2.c2s.RequestPledgeReorganizeMember.NoSuchCombatUnit"));
			activeChar.sendActionFailed();
			return;
		}
		...
		{
			activeChar.sendMessage(new CustomMessage("org.l2j.gameserver.network.l2.c2s.RequestPledgeReorganizeMember.AcademyViaInvitation"));
			activeChar.sendActionFailed();
			return;
		}
		/*
		...
		{
			activeChar.sendMessage(new CustomMessage("org.l2j.gameserver.network.l2.c2s.RequestPledgeReorganizeMember.CantMoveAcademyMember"));
			activeChar.sendActionFailed();
			return;
		}
		...
		if(_replace > 0)
		{
			...
			if(replacement == null)
			{
				activeChar.sendMessage(new CustomMessage("org.l2j.gameserver.network.l2.c2s.RequestPledgeReorganizeMember.CharacterNotBelongClan"));
				activeChar.sendActionFailed();
				return;
			}
			if(replacement.getPledgeType() != _targetUnit)
			{
				activeChar.sendMessage(new CustomMessage("org.l2j.gameserver.network.l2.c2s.RequestPledgeReorganizeMember.CharacterNotBelongCombatUnit"));
				activeChar.sendActionFailed();
				return;
			}
			if(replacement.isSubLeader() != 0)
			{
				activeChar.sendMessage(new CustomMessage("org.l2j.gameserver.network.l2.c2s.RequestPledgeReorganizeMember.CharacterLeaderAnotherCombatUnit"));
				activeChar.sendActionFailed();
				return;
			}
		}
		else
		{
			...
			{
				activeChar.sendMessage(new CustomMessage("org.l2j.gameserver.network.l2.c2s.RequestPledgeReorganizeMember.MemberLeaderAnotherUnit"));
				activeChar.sendActionFailed();
				return;
			}
