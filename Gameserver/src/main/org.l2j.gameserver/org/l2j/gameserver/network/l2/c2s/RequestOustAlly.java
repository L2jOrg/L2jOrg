...
public class RequestOustAlly extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if(clan != null)
		{
			...
			//activeChar.sendMessage(new CustomMessage("org.l2j.gameserver.network.l2.c2s.RequestOustAlly.ClanDismissed", activeChar).addString(clan.getName()).addString(alliance.getAllyName()));
		}
	}
}