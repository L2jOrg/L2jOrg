...
public final class RequestDropItem extends ClientPacket {
    ...
    public void runImpl() {
        ...
        final Item dropedItem = activeChar.dropItem("Drop", _objectId, _count, _x, _y, _z, null, false, false);
