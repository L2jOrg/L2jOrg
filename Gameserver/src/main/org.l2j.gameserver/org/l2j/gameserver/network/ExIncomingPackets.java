...
public enum ExIncomingPackets implements PacketFactory {
    ...
    EX_PROCURE_CROP_LIST(RequestProcureCropList::new, ConnectionState.IN_GAME),
    EX_SET_SEED(RequestSetSeed::new, ConnectionState.IN_GAME),
    EX_SET_CROP(RequestSetCrop::new, ConnectionState.IN_GAME),
    ...
    EX_ENCHANT_SKILL_INFO(RequestExEnchantSkillInfo::new, ConnectionState.IN_GAME),
    EX_REQ_ENCHANT_SKILL(RequestExEnchantSkill::new, ConnectionState.IN_GAME),
    ...
    EX_CHOOSE_INVENTORY_ATTRIBUTE_ITEM(RequestExEnchantItemAttribute::new, ConnectionState.IN_GAME),
    EX_CHARACTER_BACK(RequestGotoLobby::new, ConnectionState.AUTHENTICATED),
    EX_CANNOT_AIRSHIP_MOVE_ANYMORE(null, ConnectionState.AUTHENTICATED),
    EX_MOVE_TO_LOCATION_AIRSHIP(null, ConnectionState.IN_GAME),
    EX_ITEM_AUCTION_BID(RequestBidItemAuction::new, ConnectionState.IN_GAME),
    EX_ITEM_AUCTION_INFO(RequestInfoItemAuction::new, ConnectionState.IN_GAME),
    ...
    EX_SHOW_FORTRESS_SIEGE_INFO(RequestFortressSiegeInfo::new, ConnectionState.IN_GAME),
    EX_GET_BOSS_RECORD(RequestGetBossRecord::new, ConnectionState.IN_GAME),
    ...
    EX_ENCHANT_SKILL_INFO_DETAIL(RequestExEnchantSkillInfoDetail::new, ConnectionState.IN_GAME),
    EX_REQUEST_ANTI_FREE_SERVER(null, ConnectionState.IN_GAME),
    EX_SHOW_FORTRESS_MAP_INFO(RequestFortressMapInfo::new, ConnectionState.IN_GAME),
    ...
    EX_USER_BOOKMARK(null, true, ConnectionState.IN_GAME),
    EX_WITHDRAW_PREMIUM_ITEM(RequestWithDrawPremiumItem::new, ConnectionState.IN_GAME),
    EX_JUMP(null, ConnectionState.IN_GAME),
    EX_START_REQUEST_PVPMATCH_CC_RANK(RequestStartShowKrateisCubeRank::new, ConnectionState.IN_GAME),
    EX_STOP_REQUEST_PVPMATCH_CC_RANK(RequestStopShowKrateisCubeRank::new, ConnectionState.IN_GAME),
    ...
    EX_REQUEST_SHOW_PETITION(null, ConnectionState.IN_GAME),
    EX_REQUEST_SHOWSTEP_TWO(null, ConnectionState.IN_GAME),
    EX_REQUEST_SHOWSTEP_THREE(null, ConnectionState.IN_GAME),
    ...
    EX_BR_PRODUCT_LIST_REQ(RequestBRProductList::new, ConnectionState.IN_GAME),
    EX_BR_PRODUCT_INFO_REQ(RequestBRProductInfo::new, ConnectionState.IN_GAME),
    EX_BR_BUY_PRODUCT_REQ(RequestBRBuyProduct::new, ConnectionState.IN_GAME),
    EX_BR_RECENT_PRODUCT_REQ(RequestBRRecentProductList::new, ConnectionState.IN_GAME),
    EX_BR_MINIGAME_LOAD_SCORES_REQ(null, ConnectionState.IN_GAME),
    EX_BR_MINIGAME_INSERT_SCORE_REQ(null, ConnectionState.IN_GAME),
    EX_BR_SET_LECTURE_MARK_REQ(null, ConnectionState.IN_GAME),
    ...
    EX_UPDATE_FRIEND_MEMO(null, ConnectionState.IN_GAME),
    EX_UPDATE_BLOCK_MEMO(null, ConnectionState.IN_GAME),
    EX_LOAD_INZONE_PARTY_HISTORY(null, ConnectionState.IN_GAME),
    EX_REQUEST_COMMISSION_ITEM_LIST(RequestCommissionRegistrableItemList::new, ConnectionState.IN_GAME),
    EX_REQUEST_COMMISSION_INFO(RequestCommissionInfo::new, ConnectionState.IN_GAME),
    EX_REQUEST_COMMISSION_REGISTER(RequestCommissionRegister::new, ConnectionState.IN_GAME),
    EX_REQUEST_COMMISSION_CANCEL(RequestCommissionCancel::new, ConnectionState.IN_GAME),
    EX_REQUEST_COMMISSION_DELETE(RequestCommissionDelete::new, ConnectionState.IN_GAME),
    EX_REQUEST_COMMISSION_SEARCH(RequestCommissionList::new, ConnectionState.IN_GAME),
    EX_REQUEST_COMMISSION_BUY_INFO(RequestCommissionBuyInfo::new, ConnectionState.IN_GAME),
    EX_REQUEST_COMMISSION_BUY_ITEM(RequestCommissionBuyItem::new, ConnectionState.IN_GAME),
    EX_REQUEST_COMMISSION_REGISTERED_ITEM(RequestCommissionRegisteredItem::new, ConnectionState.IN_GAME),
    EX_CALL_TO_CHANGE_CLASS(null, ConnectionState.IN_GAME),
    EX_CHANGE_TO_AWAKENED_CLASS(RequestChangeToAwakenedClass::new, ConnectionState.IN_GAME),
    EX_NOT_USED_163(DISCARD, ConnectionState.IN_GAME),
    EX_NOT_USED_164(DISCARD, ConnectionState.IN_GAME),
    ...
    EX_CHANGE_ATTRIBUTE_ITEM(RequestChangeAttributeItem::new, ConnectionState.IN_GAME),
    EX_REQUEST_CHANGE_ATTRIBUTE(SendChangeAttributeTargetItem::new, ConnectionState.IN_GAME),
    EX_CHANGE_ATTRIBUTE_CANCEL(RequestChangeAttributeCancel::new, ConnectionState.IN_GAME),
    EX_BR_BUY_PRODUCT_GIFT_REQ(RequestBRPresentBuyProduct::new, ConnectionState.IN_GAME),
    EX_MENTOR_ADD(ConfirmMenteeAdd::new, ConnectionState.IN_GAME),
    EX_MENTOR_CANCEL(RequestMentorCancel::new, ConnectionState.IN_GAME),
    EX_MENTOR_LIST(RequestMentorList::new, ConnectionState.IN_GAME),
    EX_REQUEST_MENTOR_ADD(RequestMenteeAdd::new, ConnectionState.IN_GAME),
    EX_MENTEE_WAITING_LIST(RequestMenteeWaitingList::new, ConnectionState.IN_GAME),
    ...
    EX_JOIN_CURIOUS_HOUSE(RequestJoinCuriousHouse::new, ConnectionState.IN_GAME),
    EX_CANCEL_CURIOUS_HOUSE(RequestCancelCuriousHouse::new, ConnectionState.IN_GAME),
    ...
    EX_REQ_CURIOUS_HOUSE_HTML(RequestCuriousHouseHtml::new, ConnectionState.IN_GAME),
    EX_REQ_CURIOUS_HOUSE_RECORD(null, ConnectionState.IN_GAME),
    EX_SYS_STRING(null, ConnectionState.IN_GAME),
    EX_TRY_TO_PUT_SHAPE_SHIFTING_TARGET_ITEM(null, ConnectionState.IN_GAME), // RequestExTryToPutShapeShiftingTargetItem - Appearance Stone not used on classic
    EX_TRY_TO_PUT_SHAPE_SHIFTING_EXTRACTION_ITEM(null, ConnectionState.IN_GAME), // RequestExTryToPutShapeShiftingEnchantSupportItem - Appearance Stone not used on classic
    EX_CANCEL_SHAPE_SHIFTING(null, ConnectionState.IN_GAME), // RequestExCancelShape_Shifting_Item - Appearance Stone not used on classic
    EX_REQUEST_SHAPE_SHIFTING(null, ConnectionState.IN_GAME), // RequestShapeShiftingItem - Appearance Stone not used on classic
    EX_NCGUARD(DISCARD, ConnectionState.IN_GAME),
    ...
    EX_REQUEST_SHOW_RESET_BEAUTY(RequestShowResetShopList::new, ConnectionState.IN_GAME),
    ...
    EX_BR_EXIST_NEW_PRODUCT_REQ(null, ConnectionState.IN_GAME),
    ...
    EX_REQUEST_ALCHEMY_CONVERSION(null, ConnectionState.IN_GAME),
    EX_EXECUTED_UIEVENTS_COUNT(null, ConnectionState.IN_GAME),
    EX_CLIENT_INI(DISCARD, ConnectionState.AUTHENTICATED),
    ...
    EX_REQUEST_LUCKY_GAME_INFO(RequestVipLuckGameInfo::new, ConnectionState.IN_GAME),
    EX_REQUEST_LUCKY_GAME_ITEMLIST(null, ConnectionState.IN_GAME),
    EX_REQUEST_LUCKY_GAME_BONUS(null, ConnectionState.IN_GAME),
    EX_VIP_INFO(ExRequestVipInfo::new, ConnectionState.IN_GAME),
    EX_CAPTCHA_ANSWER(RequestCaptchaAnswer::new, ConnectionState.IN_GAME),
    EX_REFRESH_CAPTCHA_IMAGE(RequestRefreshCaptcha::new, ConnectionState.IN_GAME),
    ...
    EX_SHOW_AGIT_SIEGE_INFO(null, ConnectionState.IN_GAME),
    ...
    EX_BLOCK_PACKET_FOR_AD(ExRequestBlockListForAD::new, ConnectionState.IN_GAME),
    ...
    EX_REQUEST_CLASS_CHANGE_VERIFYING(null, ConnectionState.IN_GAME),
    EX_REQUEST_TELEPORT(ExRequestTeleport::new, ConnectionState.IN_GAME),
    EX_COSTUME_USE_ITEM(ExRequestCostumeUseItem::new, ConnectionState.IN_GAME),
    EX_COSTUME_LIST(ExRequestCostumeList::new, ConnectionState.IN_GAME),
    EX_COSTUME_COLLECTION_SKILL_ACTIVE(ExRequestCostumeCollectSkillActive::new, ConnectionState.IN_GAME),
    EX_COSTUME_EVOLUTION(ExRequestCostumeEvolution::new, ConnectionState.IN_GAME),
    EX_COSTUME_EXTRACT(ExRequestCostumeExtract::new, ConnectionState.IN_GAME),
    EX_COSTUME_LOCK(ExRequestCostumeLock::new, ConnectionState.IN_GAME),
    EX_COSTUME_CHANGE_SHORTCUT(null, ConnectionState.IN_GAME),
    EX_MAGICLAMP_GAME_INFO(null, ConnectionState.IN_GAME),
    EX_MAGICLAMP_GAME_START(null, ConnectionState.IN_GAME),
    EX_ACTIVATE_AUTO_SHORTCUT(ExRequestActivateAutoShortcut::new, ConnectionState.IN_GAME),
    EX_PREMIUM_MANAGER_LINK_HTML(ExRequestActivateAutoShortcut::new, ConnectionState.IN_GAME),
    EX_PREMIUM_MANAGER_PASS_CMD_TO_SERVER(ExRequestActivateAutoShortcut::new, ConnectionState.IN_GAME),
    EX_ACTIVATED_CURSED_TREASURE_BOX_LOCATION(ExRequestActivateAutoShortcut::new, ConnectionState.IN_GAME),
    EX_PAYBACK_LIST(null, ConnectionState.IN_GAME),
    EX_PAYBACK_GIVE_REWARD(null, ConnectionState.IN_GAME),
    EX_AUTOPLAY_SETTING(ExAutoPlaySetting::new, ConnectionState.IN_GAME),
    EX_OLYMPIAD_MATCH_MAKING(null, ConnectionState.IN_GAME),
    EX_OLYMPIAD_MATCH_MAKING_CANCEL(null, ConnectionState.IN_GAME),
    EX_FESTIVAL_BM_INFO(null, ConnectionState.IN_GAME),
    EX_FESTIVAL_BM_GAME(null, ConnectionState.IN_GAME),
    ...
    EX_TIME_RESTRICT_FIELD_LIST(ExTimedHuntingZoneList::new, ConnectionState.IN_GAME),
    EX_TIME_RESTRICT_FIELD_USER_ENTER(ExTimedHuntingZoneEnter::new, ConnectionState.IN_GAME),
    EX_RANKING_CHAR_INFO(ExRankCharInfo::new, ConnectionState.IN_GAME),
    EX_RANKING_CHAR_HISTORY(ExRequestRankingCharHistory::new, ConnectionState.IN_GAME),
    EX_RANKING_CHAR_RANKERS(ExRankingCharRankers::new, ConnectionState.IN_GAME),
    EX_PLEDGE_MERCENARY_RECRUIT_INFO_SET(null, ConnectionState.IN_GAME),
    EX_MERCENARY_CASTLEWAR_CASTLE_INFO(null, ConnectionState.IN_GAME),
    EX_MERCENARY_CASTLEWAR_CASTLE_SIEGE_INFO(null, ConnectionState.IN_GAME),
    EX_MERCENARY_CASTLEWAR_CASTLE_SIEGE_ATTACKER_LIST(null, ConnectionState.IN_GAME),
    EX_MERCENARY_CASTLEWAR_CASTLE_SIEGE_DEFENDER_LIST(null, ConnectionState.IN_GAME),
    EX_PLEDGE_MERCENARY_MEMBER_LIST(null, ConnectionState.IN_GAME),
    EX_PLEDGE_MERCENARY_MEMBER_JOIN(null, ConnectionState.IN_GAME),
    EX_PVPBOOK_LIST(ExRequestPvpBookList::new, ConnectionState.IN_GAME),
    EX_PVPBOOK_KILLER_LOCATION(ExRequestKillerLocation::new, ConnectionState.IN_GAME),
    EX_PVPBOOK_TELEPORT_TO_KILLER(ExTeleportToKiller::new, ConnectionState.IN_GAME),
    EX_LETTER_COLLECTOR_TAKE_REWARD(null, ConnectionState.IN_GAME),
    EX_SET_STATUS_BONUS(ExSetStatusBonus::new, ConnectionState.IN_GAME),
    EX_RESET_STATUS_BONUS(ExResetStatusBonus::new, ConnectionState.IN_GAME),
    EX_OLYMPIAD_MY_RANKING_INFO(ExRequestOlympiadMyRank::new, ConnectionState.IN_GAME),
    EX_OLYMPIAD_RANKING_INFO(ExRequestOlympiadRanking::new, ConnectionState.IN_GAME),
    EX_OLYMPIAD_HERO_AND_LEGEND_INFO(ExRequestOlympiadHeroes::new, ConnectionState.IN_GAME),
    EX_CASTLEWAR_OBSERVER_START(null, ConnectionState.IN_GAME),
    EX_RAID_TELEPORT_INFO(null, ConnectionState.IN_GAME),
    EX_TELEPORT_TO_RAID_POSITION(null, ConnectionState.IN_GAME),
    EX_CRAFT_EXTRACT(null, ConnectionState.IN_GAME),
    EX_CRAFT_RANDOM_INFO(null, ConnectionState.IN_GAME),
    EX_CRAFT_RANDOM_LOCK_SLOT(null, ConnectionState.IN_GAME),
    EX_CRAFT_RANDOM_REFRESH(null, ConnectionState.IN_GAME),
    EX_CRAFT_RANDOM_MAKE(null, ConnectionState.IN_GAME),
    EX_MULTI_SELL_LIST(null, ConnectionState.IN_GAME),
    EX_SAVE_ITEM_ANNOUNCE_SETTING(null, ConnectionState.IN_GAME),
    EX_OLYMPIAD_UI(null, ConnectionState.IN_GAME),
    EX_SHARED_POSITION_TELEPORT_UI(null, ConnectionState.IN_GAME),
    EX_SHARED_POSITION_TELEPORT(null, ConnectionState.IN_GAME),
    EX_AUTH_RECONNECT(null, ConnectionState.IN_GAME),
    EX_PET_EQUIP_ITEM(null, ConnectionState.IN_GAME),
    EX_PET_UNEQUIP_ITEM(null, ConnectionState.IN_GAME),
    ...
    EX_PK_PENALTY_LIST(null, ConnectionState.IN_GAME),
    EX_PK_PENALTY_LIST_ONLY_LOC(null, ConnectionState.IN_GAME)
    ;
    ...
    public boolean canHandleState(ConnectionState state) {
        return contains(connectionStates, state);
    }
