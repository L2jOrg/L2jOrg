...
public final class Player extends Playable implements PlayerGroup
{
	...
	public void onZoneEnter(Zone zone)
	{
		...
		if(zone.getType() == ZoneType.buff_store && Config.BUFF_STORE_ALLOWED_CLASS_LIST.contains(getClassId().getId()))
			sendPacket(new SayPacket2(0, ChatType.BATTLEFIELD, getName(), new CustomMessage("org.l2j.gameserver.model.Player.EnterOfflineBufferZone").toString(this)));
	...
	{
		if(zone.getType() == ZoneType.buff_store && Config.BUFF_STORE_ALLOWED_CLASS_LIST.contains(getClassId().getId()))
			sendPacket(new SayPacket2(0, ChatType.BATTLEFIELD, getName(), new CustomMessage("org.l2j.gameserver.model.Player.ExitOfflineBufferZone").toString(this)));
