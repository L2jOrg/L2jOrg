    ...
    public double calc(Creature creature, Optional<Double> base, Stat stat) {
        ...
        if (isPlayer(creature)) {
            ...
            if (player.isInsideZone(ZoneType.CLAN_HALL) && (player.getClan() != null) && (player.getClan().getHideoutId() > 0)) {
                final ClanHallZone zone = ZoneEngine.getInstance().getZone(player, ClanHallZone.class);
            ...
            if (player.isInsideZone(ZoneType.CASTLE) && (player.getClan() != null) && (player.getClan().getCastleId() > 0)) {
                final CastleZone zone = ZoneEngine.getInstance().getZone(player, CastleZone.class);
            ...
            if (player.isInsideZone(ZoneType.MOTHER_TREE)) {
                final MotherTreeZone zone = ZoneEngine.getInstance().getZone(player, MotherTreeZone.class);
