...
public class SubUnit
{
	...
	public void restore()
	{
		...
		try
		{
			...
			while(rset.next())
			{
				UnitMember member = new UnitMember(_clan, rset.getString("char_name"), rset.getString("title"), rset.getInt("level"), rset.getInt("classid"), rset.getInt("obj_Id"), _type, rset.getInt("pledge_rank"), rset.getInt("apprentice"), rset.getInt("sex"), -128, org.l2j.gameserver.model.base.PledgeAttendanceType.VALUES[rset.getInt("clan_attendance")]);
