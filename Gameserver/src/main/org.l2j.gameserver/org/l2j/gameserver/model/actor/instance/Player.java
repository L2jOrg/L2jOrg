            ...
            if (isInParty()) {
                ...
                if (weapon != null) {
                    ...
                    if (etcItem != null) {
                        ...
                        if (((weapon.getItemType() == WeaponType.BOW) && (itemType == EtcItemType.ARROW)) || ((weapon.getItemType() == WeaponType.SHOOTER) && (itemType == EtcItemType.ELEMENTAL_ORB)) || (((weapon.getItemType() == WeaponType.CROSSBOW) || (weapon.getItemType() == WeaponType.TWO_HAND_CROSSBOW)) && (itemType == EtcItemType.BOLT))) {
