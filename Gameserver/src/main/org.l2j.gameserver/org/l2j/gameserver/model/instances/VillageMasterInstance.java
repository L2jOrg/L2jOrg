...
public final class VillageMasterInstance extends NpcInstance
{
	...
	public void setLeader(Player leader, String newLeader)
	{
		...
		{
			leader.sendMessage(new CustomMessage("org.l2j.gameserver.model.instances.L2VillageMasterInstance.CannotAssignUnitLeader"));
			return;
		}
	...
	{
		player.sendMessage(new CustomMessage("org.l2j.gameserver.model.instances.L2VillageMasterInstance.ClanLeaderWillBeChangedFromS1ToS2").addString(clan.getLeaderName()).addString(newLeader.getName()));
