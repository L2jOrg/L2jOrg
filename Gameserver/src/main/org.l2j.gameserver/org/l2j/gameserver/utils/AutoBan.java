...
public final class AutoBan
{
	...
	public static boolean ChatBan(String actor, int period, String msg, String GM)
	{
		...
		if(plyr != null)
		{
			...
			plyr.sendMessage(new CustomMessage("org.l2j.Util.AutoBan.ChatBan").addString(GM).addNumber(period));
	...
	public static boolean ChatUnBan(String actor, String GM)
	{
		...
		if(plyr != null)
		{
			plyr.sendMessage(new CustomMessage("org.l2j.Util.AutoBan.ChatUnBan").addString(GM));
