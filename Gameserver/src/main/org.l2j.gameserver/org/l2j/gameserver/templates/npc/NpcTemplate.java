...
public class NpcTemplate extends CreatureTemplate
{
	...
	public NpcAI getNewAI(NpcInstance npc)
	{
		...
		if(constructorAI == null)
		{
			...
			try
			{
				classAI = (Class<NpcAI>) Class.forName("org.l2j.gameserver.ai." + ai);
			}
	...
	protected void setType(String type)
	{
		...
		try
		{
			classType = (Class<NpcInstance>) Class.forName("org.l2j.gameserver.model.instances." + type + "Instance");
		}
		catch(ClassNotFoundException e)
		{
		...
		if(_npcId == 0) //temp
		{
			try
			{
				classType = (Class<NpcInstance>) Class.forName("org.l2j.gameserver.model.instances.NpcInstance");
			}
			catch(ClassNotFoundException e)
			{
			}
