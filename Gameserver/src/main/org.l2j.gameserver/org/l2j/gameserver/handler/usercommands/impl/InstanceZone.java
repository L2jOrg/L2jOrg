...
public class InstanceZone implements IUserCommandHandler
{
	 ...
	 * @return boolean * @see org.l2j.gameserver.handler.usercommands.IUserCommandHandler#useUserCommand(int, Player)
	 */
	@Override
	 ...
	 * @return int[] * @see org.l2j.gameserver.handler.usercommands.IUserCommandHandler#getUserCommandList()
	 */
	@Override
