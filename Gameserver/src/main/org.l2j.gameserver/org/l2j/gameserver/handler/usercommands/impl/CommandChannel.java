...
import org.l2j.gameserver.network.l2.s2c.ExMultiPartyCommandChannelInfoPacket;
	...
	public boolean useUserCommand(int id, Player activeChar)
	{
		...
		switch(id)
		{
			...
			case 93: //channeldelete
				...
				{
					org.l2j.gameserver.model.CommandChannel channel = activeChar.getParty().getCommandChannel();
